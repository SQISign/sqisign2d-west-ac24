...
#if defined _MSC_VER
#define inner_gf27500_umul(lo, hi, x, y)   do { \
                uint64_t umul_hi; \
                (lo) = _umul128((x), (y), &umul_hi); \
                (hi) = umul_hi; \
        } while (0)
#define inner_gf27500_umul_add(lo, hi, x, y, z)   do { \
...
#define inner_gf27500_umul_x2(lo, hi, x1, y1, x2, y2)   do { \
                uint64_t umul_lo, umul_hi; \
...
#define inner_gf27500_umul_x2_add(lo, hi, x1, y1, x2, y2, z)   do { \
                uint64_t umul_lo, umul_hi; \
                umul_lo = _umul128((x1), (y1), &umul_hi); \
                uint64_t umul_lo2, umul_hi2; \
                umul_lo2 = _umul128((x2), (y2), &umul_hi2); \
...
static inline void inner_gf27500_normalize(gf27500 *d, const gf27500 *a) {
...
// TODO
void gf27500_to_w64(uint64_t data[8], const gf27500 *a);
void gf27500_from_w64(gf27500 *out, const uint64_t data[8]);
