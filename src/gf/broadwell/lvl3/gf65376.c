...
// see gf65376.h
const gf65376 gf65376_ONE = {0x0000000000000003, 0x0000000000000000, 
                             0x0000000000000000, 0x0000000000000000, 
                             0x0000000000000000, 0x3D00000000000000};

// see gf65376.h
const gf65376 gf65376_MINUS_ONE = {0xFFFFFFFFFFFFFFFC, 0xFFFFFFFFFFFFFFFF, 
                                   0xFFFFFFFFFFFFFFFF, 0xFFFFFFFFFFFFFFFF, 
                                   0xFFFFFFFFFFFFFFFF, 0x03FFFFFFFFFFFFFF};

// Montgomery representation of 2^256.
static const gf65376 R2 = {0x3F03F03F03F03F13, 0x03F03F03F03F03F0, 
                           0xF03F03F03F03F03F, 0x3F03F03F03F03F03, 
                           0x03F03F03F03F03F0, 0x1D3F03F03F03F03F};

// The modulus itself (this is also a valid representation of zero).
static const gf65376 MODULUS = {0xFFFFFFFFFFFFFFFF, 0xFFFFFFFFFFFFFFFF,
                                0xFFFFFFFFFFFFFFFF, 0xFFFFFFFFFFFFFFFF,
...
static void gf65376_lin(gf65376 *d, const gf65376 *u, const gf65376 *v,
...
// 0x0000000000000000.
static uint64_t lindiv31abs(gf65376 *d, const gf65376 *a, const gf65376 *b,
                            uint64_t f, uint64_t g) {
...
// see gf65376.h
uint32_t gf65376_div(gf65376 *d, const gf65376 *x, const gf65376 *y) {
  // Extended binary GCD:
  //
  //   a <- y
  //   b <- q (modulus)
...
// see gf65376.h
int32_t gf65376_legendre(const gf65376 *x) {
...
void 
gf65376_to_w64(uint64_t data[6], const gf65376 *a)
{	
	// Perform Mont. reduction for Canonical
	// rep.
	gf65376 b;
	inner_gf65376_montgomery_reduce(&b, a);
...
void 
gf65376_from_w64(gf65376 *out, const uint64_t data[6])
{
    // Set the words from input data
    out->v0 = data[0];
    out->v1 = data[1];
