...
void ec_dlog_2_weil_old(digit_t* scalarP1, digit_t* scalarQ1, digit_t* scalarP2, digit_t* scalarQ2, ec_basis_t* PQ, ec_basis_t *basis, ec_curve_t* curve,int e) {
...
void weil_dlog(digit_t* scalarP1, digit_t* scalarQ1,
                ...
                uint64_t e,
                ec_point_t* P, ec_point_t* Q, ec_point_t* P1, ec_point_t* P2,
                ec_point_t* PQ,
                ec_point_t* PP1, ec_point_t* PP2,
                ec_point_t* P1Q, ec_point_t* P2Q,
                ec_point_t* A24) {
...
void ec_dlog_2_weil(digit_t* scalarP1, digit_t* scalarQ1, digit_t* scalarP2, digit_t* scalarQ2, ec_basis_t* PQ, ec_basis_t *basis, ec_curve_t* curve,int e) {
    ...
    weil_dlog(scalarP1, scalarQ1, scalarP2, scalarQ2, e,
              &PQ->P, &PQ->Q, &basis->P, &basis->Q,
              &PQ->PmQ,&PmP1, &PmP2, &P1mQ, &P2mQ, &A24);
