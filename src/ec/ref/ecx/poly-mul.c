...
void
poly_mul(poly h, const poly f, const int lenf, const poly g, const int leng)
{
...
void
poly_mul_low(poly h, const int n, const poly f, const int lenf, const poly g, const int leng)
{
    ...
    if ((n == 4) && (leng == 4)) {
        ...
        for (i = 1; i < nf; i++) {
            for (j = 1; j < n - 2 * i; j++)
                fp2_add(
                    &c[n + 2 * i - 1 + j], &c[n + 2 * i - 1 + j], &c[(1 + i) * n - i * i - 1 + j]);
        }
...
void
quasi_poly_mul_middle(poly h, const poly g, const int leng, const poly f, const int lenf)
{
...
void
poly_mul_middle(poly h, const poly g, const int leng, const poly f, const int lenf)
{
...
void
poly_mul_selfreciprocal(poly h, const poly g, const int leng, const poly f, const int lenf)
{
...
void
product_tree(poly H[], int DEG[], const int root, const poly F[], const int LENF, const int n)
{
...
void
product_tree_LENFeq2(poly H[], int DEG[], const int root, const fp2_t F[][2], const int n)
{
...
void
product_tree_LENFeq3(poly H[], int DEG[], const int root, const fp2_t F[][3], const int n)
{
...
void
product_tree_selfreciprocal(poly H[],
                            int DEG[],
                            const int root,
                            const poly F[],
                            const int LENF,
...
void
product_tree_selfreciprocal_LENFeq3(poly H[],
                                    int DEG[],
                                    const int root,
                                    const fp2_t F[][3],
                                    const int n)
{
    // Same as product_tree_selfreciprocal but allows F to be given as a double array with LENF
    // fixed to 3
...
void
clear_tree(poly H[], const int root, const int n)
{
...
void
product(fp2_t *c, const fp2_t F[], const int n)
{
