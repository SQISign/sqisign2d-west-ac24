...
void
slow_mul(poly h, poly f, int lenf, poly g, int leng)
{
...
#define nmax 16
    ...
    for (tree_size = 1; tree_size < nmax; tree_size++) {
        ...
        printf("[%3d%%] Testing product tree:\t\t\tSize %d out of %d",
               100 * tree_size / nmax,
               tree_size,
               nmax - 1);
        fflush(stdout);
    ...
    for (tree_size = 1; tree_size < nmax; tree_size++) {
        ...
        printf("[%3d%%] Testing selfreciprocal product tree:\tSize %d out of %d",
               100 * tree_size / nmax,
               tree_size,
               nmax - 1);
        fflush(stdout);
