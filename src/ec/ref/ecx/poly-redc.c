...
void
reciprocal(poly h, fp2_t *c, const poly f, const int lenf, const int n)
{
                ...
                const int n)
{
    ...
    if (root == 0 || leng < lenr) {
        ...
        // When parent's inverse was to a greater/equal modulus, this inverse can be obtained from
        // it
        for (i = 0; i < lenr; i++)
