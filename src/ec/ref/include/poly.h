...
void product_tree_selfreciprocal(poly H[],
                                 int DEG[],
                                 const int root,
                                 const poly F[],
                                 const int LENF,
                                 const int n);
void product_tree_selfreciprocal_LENFeq3(poly H[],
                                         int DEG[],
                                         const int root,
                                         const fp2_t F[][3],
                                         const int n);
...
void reciprocal_tree(poly *R,
                     ...
                     const int root,
                     const int n);
void multieval_unscaled(fp2_t REM[],
                        const poly g,
                        const int leng,
                        const poly R[],
                        const fp2_t A[],
                        ...
                        const int root,
                        const int n);
void multieval_scaled(fp2_t REM[],
                      const poly G,
                      const poly H[],
                      const int DEG[],
                      const int root,
